...
class INET_API GenericNetworkProtocolControlInfo : public GenericNetworkProtocolControlInfo_Base, public INetworkProtocolControlInfo
{
  ...
  public:
    ...
    virtual int getExplicitCongestionNotification() const override { return -1; } //mona: added for stability
    virtual void setExplicitCongestionNotification(int ecn) override {} //mona: added for stability
};
